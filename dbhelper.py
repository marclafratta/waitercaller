...
class DBHelper:
    def __init__(self):
        client = pymongo.MongoClient("mongodb+srv://appdb:7saMCY$V9wFWh^93@cluster0-qgfnl.mongodb.net")
    ...
    def add_request(self, table_id, time):
        ...
        self.db.requests.insert(
            {"owner": table['owner'], "table_number": table['number'], "table_id": table_id, "time": time})
